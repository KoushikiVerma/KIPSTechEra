...
public class JavaQuizMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Button submitBtn;
    int score=0;
    int totalQuestion=JavaQuestionsAnswer.question.length;
    ...
    public void onClick(View v) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            if(selectedAnswer.equals(JavaQuestionsAnswer.correctAnswers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(JavaQuestionsAnswer.question[currentQuestionIndex]);
        ansA.setText(JavaQuestionsAnswer.choices[currentQuestionIndex][0]);
        ansB.setText(JavaQuestionsAnswer.choices[currentQuestionIndex][1]);
        ansC.setText(JavaQuestionsAnswer.choices[currentQuestionIndex][2]);
        ansD.setText(JavaQuestionsAnswer.choices[currentQuestionIndex][3]);
    ...
    private void generateCertificate(String userName) {
        ...
        Intent intent = new Intent(this, JavaCertificateActivity.class);
