...
public class PythonQuizMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Button submitBtn;
    int score=0;
    int totalQuestion=PythonQuestionAnswer.question.length;
    ...
    public void onClick(View v) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            if(selectedAnswer.equals(PythonQuestionAnswer.correctAnswers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(PythonQuestionAnswer.question[currentQuestionIndex]);
        ansA.setText(PythonQuestionAnswer.choices[currentQuestionIndex][0]);
        ansB.setText(PythonQuestionAnswer.choices[currentQuestionIndex][1]);
        ansC.setText(PythonQuestionAnswer.choices[currentQuestionIndex][2]);
        ansD.setText(PythonQuestionAnswer.choices[currentQuestionIndex][3]);
    ...
    private void generateCertificate(String userName) {
        ...
        Intent intent = new Intent(this, PythonCertificateActivity.class);
