...
public class AndroidQuizMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Button submitBtn;
    int score=0;
    int totalQuestion=AndroidQuestionsAnswer.question.length;
    ...
    public void onClick(View v) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            if(selectedAnswer.equals(AndroidQuestionsAnswer.correctAnswers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(AndroidQuestionsAnswer.question[currentQuestionIndex]);
        ansA.setText(AndroidQuestionsAnswer.choices[currentQuestionIndex][0]);
        ansB.setText(AndroidQuestionsAnswer.choices[currentQuestionIndex][1]);
        ansC.setText(AndroidQuestionsAnswer.choices[currentQuestionIndex][2]);
        ansD.setText(AndroidQuestionsAnswer.choices[currentQuestionIndex][3]);
    ...
    private void generateCertificate(String userName) {
        ...
        Intent intent = new Intent(this, AndroidCertificateActivity.class);
