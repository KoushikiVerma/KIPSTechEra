...
public class PhpQuizMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Button submitBtn;
    int score=0;
    int totalQuestion=PhpQuestionsAnswer.question.length;
    ...
    public void onClick(View v) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            if(selectedAnswer.equals(PhpQuestionsAnswer.correctAnswers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(PhpQuestionsAnswer.question[currentQuestionIndex]);
        ansA.setText(PhpQuestionsAnswer.choices[currentQuestionIndex][0]);
        ansB.setText(PhpQuestionsAnswer.choices[currentQuestionIndex][1]);
        ansC.setText(PhpQuestionsAnswer.choices[currentQuestionIndex][2]);
        ansD.setText(PhpQuestionsAnswer.choices[currentQuestionIndex][3]);
    ...
    private void generateCertificate(String userName) {
        ...
        Intent intent = new Intent(this, PhpCertificateActivity.class);
