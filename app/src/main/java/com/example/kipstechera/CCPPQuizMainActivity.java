...
public class CCPPQuizMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Button submitBtn;
    int score=0;
    int totalQuestion=CCPPQuestionsAnswer.question.length;
    int currentQuestionIndex=0;
    String selectedAnswer="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ccppquiz);
    ...
    public void onClick(View v) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            if(selectedAnswer.equals(CCPPQuestionsAnswer.correctAnswers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(CCPPQuestionsAnswer.question[currentQuestionIndex]);
        ansA.setText(CCPPQuestionsAnswer.choices[currentQuestionIndex][0]);
        ansB.setText(CCPPQuestionsAnswer.choices[currentQuestionIndex][1]);
        ansC.setText(CCPPQuestionsAnswer.choices[currentQuestionIndex][2]);
        ansD.setText(CCPPQuestionsAnswer.choices[currentQuestionIndex][3]);
    ...
    private void generateCertificate(String userName) {
        ...
        Intent intent = new Intent(this, CCPPCertificateActivity.class);
